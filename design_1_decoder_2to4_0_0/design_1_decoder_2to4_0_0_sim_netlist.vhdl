...
--               Logiques/Laboratoires/Lab4/Experience4/Experience4.srcs/sources_1/bd/design_1/ip/design_1_decoder_2to4_0_0/design_1_decoder_2to4_0_0_sim_netlist.vhdl}
...
entity design_1_decoder_2to4_0_0_decoder_2to4 is
  port (
    an : out STD_LOGIC_VECTOR ( 1 downto 0 );
    sel : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_decoder_2to4_0_0_decoder_2to4 : entity is "decoder_2to4";
end design_1_decoder_2to4_0_0_decoder_2to4;

architecture STRUCTURE of design_1_decoder_2to4_0_0_decoder_2to4 is
...
entity design_1_decoder_2to4_0_0 is
  ...
  attribute x_core_info of design_1_decoder_2to4_0_0 : entity is "decoder_2to4,Vivado 2018.3";
end design_1_decoder_2to4_0_0;

architecture STRUCTURE of design_1_decoder_2to4_0_0 is
begin
U0: entity work.design_1_decoder_2to4_0_0_decoder_2to4
     port map (
      an(1) => an(3),
      an(0) => an(0),
